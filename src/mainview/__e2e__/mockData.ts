...
const SECTIONS: Section[] = [
  ...
  { id: 'what-is-programming', heading: 'What is Programming?', level: 2, parentID: 'getting-started' },
  { id: 'setting-up-your-environment', heading: 'Setting Up Your Environment', level: 2, parentID: 'getting-started' },
  { id: 'your-first-program', heading: 'Your First Program', level: 2, parentID: 'getting-started' },
  { id: 'understanding-program-flow', heading: 'Understanding Program Flow', level: 2, parentID: null },
  { id: 'conditional-execution', heading: 'Conditional Execution', level: 3, parentID: 'understanding-program-flow' },
  ...
  { id: 'reading-error-messages', heading: 'Reading Error Messages', level: 3, parentID: 'debugging-techniques' },
  { id: 'using-the-debugger', heading: 'Using the Debugger', level: 3, parentID: 'debugging-techniques' },
