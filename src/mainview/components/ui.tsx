...
export const buttonVariants = cva('px-3 py-1.5 text-sm rounded-lg transition-colors', {
  variants: {
    intent: {
...
export const tabVariants = cva('flex-1 px-2 py-2 text-xs font-medium transition-colors', {
  variants: {
    active: {
...
export const cardVariants = cva('bg-gray-800 border border-gray-700 rounded-xl transition-colors', {
  variants: {
    hover: {
...
export const messageVariants = cva('p-2 rounded text-xs', {
  variants: {
    role: {
